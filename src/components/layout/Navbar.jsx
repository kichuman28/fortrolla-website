...
const Navbar = () => {
  ...
  return (
    <header className={`fixed w-full z-50 transition-all duration-300 ${isScrolled ? 'bg-fortrolla-black/90 backdrop-blur-md py-3 shadow-lg' : 'bg-transparent py-5'}`}>
      <div className="container mx-auto px-4 md:px-6">
        ...
        {/* Mobile Menu */}
        {isMenuOpen && (
          <div className="md:hidden mt-4 bg-fortrolla-gray/90 backdrop-blur-md rounded-lg p-4">
