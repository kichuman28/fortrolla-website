          ...
          <div className="space-y-6">
            <div className="flex items-center space-x-3">
              ...
              <span className="font-display text-fortrolla-white text-lg">
                <span>FORTROLLA</span>
                <span className="block text-xs font-sans text-fortrolla-silver">CREATIVE</span>
              </span>
            </div>
            <p className="text-fortrolla-silver text-sm leading-relaxed">
            ...
            <div className="flex space-x-4">
              ...
              {[
                ...
                <a 
                  ...
                  className="text-fortrolla-silver hover:text-fortrolla-accent transition-colors duration-300"
                >
                  <svg 
                    viewBox="0 0 24 24" 
                    fill="currentColor" 
              ...
              {['Home', 'About Us', 'Services', 'Projects', 'Clients', 'Contact'].map((item) => (
                <li key={item}>
                  <a 
                    ...
                    className="text-fortrolla-silver hover:text-fortrolla-white transition-colors duration-300 text-sm"
                  >
                    {item}
                  </a>
                </li>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start space-x-3">
                <svg className="w-5 h-5 text-fortrolla-accent mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
                </svg>
                <span className="text-fortrolla-silver text-sm">
              ...
              <li className="flex items-center space-x-3">
                ...
                <a href="mailto:info@fortrolla.com" className="text-fortrolla-silver hover:text-fortrolla-white transition-colors duration-300 text-sm">
                  info@fortrolla.com
                </a>
              </li>
              <li className="flex items-center space-x-3">
                ...
                <a href="tel:+919876543210" className="text-fortrolla-silver hover:text-fortrolla-white transition-colors duration-300 text-sm">
                  +91 98765 43210
                </a>
              </li>
            </ul>
