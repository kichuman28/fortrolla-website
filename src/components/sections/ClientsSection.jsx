  ...
  const testimonials = [
    {
      ...
      name: "Roshan Mathew",
      title: "Actor",
      image: "https://placehold.co/100x100/8A2BE2/FFFFFF?text=RM"
    },
    {
      ...
      image: "https://placehold.co/100x100/8A2BE2/FFFFFF?text=MM"
    },
    {
      ...
      image: "https://placehold.co/100x100/8A2BE2/FFFFFF?text=AK"
    },
  ];
      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="text-center max-w-3xl mx-auto mb-16">
          <h2 className="text-fortrolla-white font-display text-3xl md:text-4xl font-bold mb-6">
            Our <span className="text-fortrolla-accent">Clients</span>
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-20">
          {testimonials.map((testimonial, index) => (
            ...
            >
              <div className="absolute top-0 left-10 transform -translate-y-1/2 text-fortrolla-accent">
              ...
              <div className="pt-4">
                <p className="text-fortrolla-silver mb-6 italic leading-relaxed">
                  "{testimonial.quote}"
                </p>
                
                <div className="flex items-center">
                  <div className="w-12 h-12 rounded-full overflow-hidden mr-4 border-2 border-fortrolla-accent/30">
                    <img 
                  ...
                  <div>
                    ...
                    <p className="text-fortrolla-silver text-sm">{testimonial.title}</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          {clients.map((client, index) => (
            <div 
              key={index} 
              className="bg-fortrolla-dark/50 rounded-lg p-6 border border-fortrolla-gray/10 flex items-center justify-center h-32 hover:border-fortrolla-accent/30 transition-all duration-300"
            >
              <span className="text-lg font-display text-fortrolla-white opacity-70 text-center">
                {client}
              </span>
            </div>
          ))}
