      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="text-center max-w-3xl mx-auto mb-16">
          <h2 className="text-fortrolla-white font-display text-3xl md:text-4xl font-bold mb-6">
            About <span className="text-fortrolla-accent">Fortrolla</span> Creative
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative">
            <div className="aspect-square rounded-lg bg-gradient-to-br from-fortrolla-accent/10 to-fortrolla-secondary/20 overflow-hidden group">
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="text-9xl font-display font-bold text-fortrolla-accent/10">F</div>
              </div>
              
              <div className="absolute inset-0 flex items-center justify-center opacity-90">
                <div className="w-3/4 h-3/4 rounded-lg border-2 border-fortrolla-accent/20 transform rotate-6 transition-transform group-hover:rotate-3"></div>
              </div>
              
              <div className="absolute inset-0 p-6 flex items-center justify-center">
                <div className="space-y-6 text-left">
                  <div className="flex items-center space-x-4">
                    <div className="w-12 h-12 rounded-full bg-fortrolla-accent/20 flex items-center justify-center">
                      <svg className="w-6 h-6 text-fortrolla-accent" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="space-y-6">
            <p className="text-lg text-fortrolla-silver leading-relaxed">
            ...
            <div className="grid grid-cols-2 gap-6 my-8">
              {[
                ...
                <div key={index} className="p-4 bg-fortrolla-black/50 rounded-lg border border-fortrolla-gray/20 text-center">
                  <div className="text-3xl font-bold text-fortrolla-accent mb-1">{stat.value}</div>
                  <div className="text-sm text-fortrolla-silver">{stat.label}</div>
                </div>
              ))}
            </div>
